...
module.exports.wifiCon = function () {
    /*******************************************
...
module.exports.wifi370 = function (ip, name) {
    /*******************************************
	...
	***************************************************/
    ...
    var PORT = '5000' //the default port can be changed in the STA settings of the LED controller
    ...
    controller.socket.on("connect", function () {
        ...
        //controller.socket.write(COMMAND_INIT, 'binary')
        //console.log((name || ip) + " is connected")
        //controller.socket.write(COMMAND_INIT, 'binary')
        //console.log((name || ip) + " is off")
        //controller.socket.write(COMMAND_OFF, 'binary')
        controller.socket.write(new Buffer([86, 250, 0, 0, 170]))
    })
